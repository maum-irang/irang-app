            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-end space-y-3">
                <button
                  ...
                  className="w-full py-3 px-6 bg-blue-400 text-white rounded-2xl font-normal text-base transition-all duration-300 active:scale-95 flex items-center justify-center space-x-2"
                >
                  <RotateCcw size={20} />
                  <span>다시 도전하기</span>
                </button>
                ...
                {isPassed ? (
                  <>
                    <button
                      onClick={handleHome}
                      className="w-full py-3 px-6 bg-gray-200 text-gray-800 rounded-2xl font-normal text-base transition-all duration-300 active:scale-95 flex items-center justify-center space-x-2"
                    >
                      <Home size={20} />
                      <span>학습 종료하기</span>
                    </button>
                  ...
                  <button
                    className="w-full py-3 px-6 bg-gray-300 text-gray-500 rounded-2xl font-normal text-base cursor-not-allowed flex items-center justify-center space-x-2 opacity-50"
                    disabled
                  >
                    <Home size={20} />
                    <span>메인으로 돌아가기</span>
