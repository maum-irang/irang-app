     ...
     if (stamp.completed) {
       return (
         <div className="relative flex flex-col items-center">
           ...
           <div className="absolute top-0 left-1 w-12 h-8 bg-green-500 shadow-lg flex items-center justify-center"
                style={{
       ...
       return (
         <div className="relative flex flex-col items-center">
           <div className="w-1 h-16 bg-gray-600 rounded-full mb-2"></div>
           <div className="absolute top-0 left-1 w-12 h-8 bg-red-500 shadow-lg flex items-center justify-center animate-pulse"
                style={{
                  clipPath: 'polygon(0% 0%, 85% 0%, 100% 50%, 85% 100%, 0% 100%)'
                }}>
       ...
       return (
         <div className="relative flex flex-col items-center">
           ...
           <div className="absolute top-0 left-1 w-12 h-8 bg-gray-300 shadow-md flex items-center justify-center opacity-60"
                style={{
                  clipPath: 'polygon(0% 0%, 85% 0%, 100% 50%, 85% 100%, 0% 100%)'
                }}>
     ...
     >
       <div className="flex flex-col items-center">
         ...
         <div className="mt-2 backdrop-blur-sm rounded-lg px-2 py-1">
           <span className="text-gray-800 text-xs font-bold">{stamp.id}일차</span>
         </div>
       </div>
     </div>
   );
   ...
   <div className="relative">
     ...
     >
       ...
       <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-center z-10">
         ...
         <p className="text-white/90 font-bold text-base">매일 깃발을 세워보세요!</p>
