...
import { ChevronLeft, Home, RotateCcw, ArrowRight } from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto w-full relative z-20">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-3xl font-black text-black">
          1단계 <span className={isPassed ? "text-accent-primary" : "text-red-500"}>
            {isPassed ? "완료" : "재도전"}
          </span>!
        </h1>
      </div>
        ...
        <div>
          ...
          >
            <div className="text-center mb-8">
              <h3 className="text-2xl font-black text-gray-800 mb-2">최종 점수</h3>
              <div className={`text-4xl font-black mb-2 ${isPassed ? 'text-accent-primary' : 'text-red-500'}`}>
                {score} / {total}
              </div>
            ...
            <div className="space-y-3">
              ...
              {isPassed ? (
                <>
                  ...
                  <button
                    onClick={() => console.log('2단계로 이동')}
                    className="w-full py-3 px-6 bg-accent-primary text-white rounded-2xl font-black text-base transition-all duration-300 active:scale-95 flex items-center justify-center space-x-2"
                  >
                    <span>2단계로 이동하기</span>
                    <ArrowRight size={20} />
                  </button>
