interface AnswerOptionsProps {
  ...
  export const AnswerOptions: React.FC<AnswerOptionsProps> = ({
    ...
    const getButtonStyle = (index: number) => {
      const baseStyle = "text-gray-800 rounded-3xl p-6 text-center min-h-[120px] flex items-center justify-center transition-all duration-200 border-3 font-black text-xl relative overflow-hidden";
