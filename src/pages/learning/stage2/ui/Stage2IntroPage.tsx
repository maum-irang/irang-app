...
export const Stage2IntroPage = () => {
 ...
 const fullText = '안녕 마음아! 이번에는 2단계 감정 표현 학습이야.\n목소리로 감정을 표현하고 인식하는 연습을 해보자. 준비됐니?';
 ...
 const renderHighlightedText = (text: string) => {
   ...
   highlightWords.forEach(word => {
     ...
     result = result.replace(regex, `<span class="text-purple-500 font-black">$1</span>`);
   });
           ...
           >
             ...
             <div className="space-y-4 mb-6">
               <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-xl">
                 ...
                 <div>
                   <p className="font-black text-gray-800 text-sm">음성 인식</p>
                   <p className="text-gray-600 text-xs">목소리 톤과 억양 학습</p>
                 </div>
               </div>
               ...
               <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-xl">
                 ...
                 <div>
                   <p className="font-black text-gray-800 text-sm">실시간 피드백</p>
