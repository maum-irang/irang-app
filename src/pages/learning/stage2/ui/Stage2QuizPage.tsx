     ...
     <div className="max-w-4xl mx-auto w-full">
       <div className="flex items-center mb-6">
         ...
         <h1 className="text-3xl font-black text-black">
           2단계 <span className="text-purple-500">AI 대화</span>
         </h1>
       </div>
       ...
       <div className="mb-8">
         ...
         >
           <div className="flex items-center mb-4">
             ...
             <h3 className="text-lg font-black text-purple-500">마음이가 말하고 있어요</h3>
           </div>
           
           <div className="bg-purple-50 rounded-2xl p-6 relative">
       ...
       <div className="mt-8 text-center">
         <div className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-sm rounded-full px-6 py-3">
           <div className={`w-3 h-3 rounded-full ${isTyping ? 'bg-purple-500 animate-pulse' : 'bg-green-500'}`}></div>
